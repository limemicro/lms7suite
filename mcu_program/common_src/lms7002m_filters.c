...
#define BATCH_RX_SETUP 1
#if BATCH_RX_SETUP
    {
        ...
        ROM const uint16_t RxFilterSetupWrOnlyAddr[] = {0x0082,0x0086,0x0087,0x0088,0x0089,0x008A,0x008C,0x0100,0x0101,0x0102,0x0103,0x0104,0x0105,0x0106,0x0107,0x0108,0x0109,0x010A,0x010C,0x0115,0x0116,0x0117,0x0118,0x0119,0x011A,0x0200,0x0201,0x0202,0x0208,0x0240,0x0400,0x0401,0x0402,0x0403,0x040A,0x040C,0x0440, 0x0081,0x0404,0x0405,0x0406,0x0407,0x0408,0x0409,0x0203,0x0204,0x0205,0x0206,0x0207,0x0209};
        ROM const uint16_t RxFilterSetupWrOnlyData[] = {0x8003,0x4901,0x0400,0x0780,0x0020,0x0514,0x067B,0x3409,0x6001,0x3180,0x0612,0x0088,0x0007,0x318C,0x318C,0x0426,0x61C1,0x104C,0x88C5,0x0009,0x8180,0x280C,0x018C,0x528B,0x2E02,0x008D,0x07FF,0x07FF,0x2070,0x0020,0x0081,0x07FF,0x07FF,0x4000,0x1001,0x2038,0x0020};
...
#define BATCH_TX_SETUP 1
#if BATCH_TX_SETUP
    {
        ...
        ROM const uint16_t TxFilterSetupWrOnlyAddr[] = {0x0086,0x0087,0x0088,0x0089,0x008A,0x008C,0x0105,0x0106,0x0107,0x0108,0x0109,0x010A,0x0115,0x0116,0x0117,0x0118,0x0119,0x011A,0x0200,0x0201,0x0202,0x0208,0x0240,0x0400,0x0401,0x0402,0x0403,0x040A,0x040C,0x0440,0x0441,0x0081,0x0404,0x0405,0x0406,0x0407,0x0408,0x0409,0x0203,0x0204,0x0205,0x0206,0x0207,0x0241};
        ROM const uint16_t TxFilterSetupWrOnlyData[] = {0x4901,0x0400,0x0780,0x0020,0x0514,0x067B,0x3007,0x318C,0x318C,0x058C,0x61C1,0x104C,0x000D,0x8180,0x280C,0x618C,0x528C,0x2E02,0x008D,0x07FF,0x07FF,0x0070,0x0020,0x0081,0x07FF,0x07FF,0x4000,0x1001,0x2038,0x0020};
        ROM const RegisterBatch batch = {
